...
if (isset($_POST['getvalue'])) {
   ...
   $sql = "INSERT INTO new_application(name,designation,department,reason_type,no_of_days,reason) VALUES ('$name','$designation','$department','$reason_type','$no_of_days','$reason')";
   mysqli_query($db,$sql);
 }
...
<body>
  ...
  <div class="login">
      ...
      <form name="newform" method="post" action="">
        <input type="text" name="name" placeholder="Name" required="required" class="input-txt" id="textfocus" autofocus/>
       ...
       <input type="number" name="no_of_days" placeholder="Number of days" required="required" class="input-txt" />
        <input type="text" name="reason" placeholder="Reason" required="required" class="input-txt" />
          ...
          <div class="login-footer">
            ...
            <button type="submit" class="btn btn--right" name="getvalue">Transfer to Principal  </button>
